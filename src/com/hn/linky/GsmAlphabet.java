...
public class GsmAlphabet {
    ...
    public static int
    charToGsm(char c, boolean throwException) throws Exception {
        int ret;
     ...
     */
    public static int
    countGsmSeptets(char c, boolean throwsException) throws Exception {
     ...
     */
    public static int
    countGsmSeptets(CharSequence s, boolean throwsException) throws Exception {
        int charIndex = 0;
        int sz = s.length();
        int count = 0;
